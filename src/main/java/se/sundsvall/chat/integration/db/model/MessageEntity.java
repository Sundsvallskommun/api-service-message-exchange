...
public class MessageEntity {
	...
	private List<ParticipantEntity> readBy;
	...
	public ParticipantEntity getCreatedBy() {
		return createdBy;
	}

	public void setCreatedBy(final ParticipantEntity createdBy) {
		this.createdBy = createdBy;
	}

	public MessageEntity withCreatedBy(final ParticipantEntity createdBy) {
		this.createdBy = createdBy;
		return this;
	}
	...
	public List<ParticipantEntity> getReadBy() {
		return readBy;
	}

	public void setReadBy(final List<ParticipantEntity> readBy) {
		this.readBy = readBy;
	}

	public MessageEntity withReadBy(final List<ParticipantEntity> readBy) {
		this.readBy = readBy;
		return this;
	}
