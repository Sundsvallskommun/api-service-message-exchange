...
import static se.sundsvall.chat.service.Mapper.toMessageEntity;
...
import se.sundsvall.chat.integration.db.AttachmentRepository;
import se.sundsvall.chat.integration.db.ConversationRepository;
import se.sundsvall.chat.integration.db.MessageRepository;
...
public class MessageService {
	...
	public String createMessage(final String municipalityId, final String namespace, final String conversationId, final MessageRequest message, final List<MultipartFile> attachments) {
